...
try
{
         Class.forName("com.mysql.jdbc.Driver");
           Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/emailsoftware", "root", "PHW#84#vijay");
           Statement st=conn.createStatement();
           int i=st.executeUpdate("insert into emails(mfrom,mto,subject,mtext,inbox,sentbox)values('"+mfrom+"','"+mto+"','"+subject+"','"+mtext+"',1,1)");
