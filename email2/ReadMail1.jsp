...
String sql ="select * from emails where mid="+mid;
...
<tr><td></td><td><br><br><a href="DeleteInbox.jsp?mid=<%=mid%>">Delete</a></form><form name=f2 action=inbox.jsp><input type=submit value="Back" class="myButton"></td></tr>
